...
class Template:
  ...
  def installTemplate(self, template_id, data={}):
    return requests.post('{api_endpoint}/template/{template_id}'.format(api_endpoint=API_TAGO, template_id=template_id), headers=self.default_headers, data=data).json()
