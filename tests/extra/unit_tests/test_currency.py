...
def test_currency():
	with requests_mock.Mocker() as cur_mock:
		...
		#Good case
		response = currency('2bf1c721f5b33ea0977b79a832ac4640').convert('USD', 'EUR')
		check_status(response, True)
		
		# Bad case
		response = currency('2bf1c721f5b33ea0977b79a832ac4640').convert('US', 'EUR')
		check_status(response, False)

		# Bad case
		response = currency('2bf1c721f5b33ea0977b79a832ac4640').convert('USD', 'EU')
		check_status(response, False)
